...
<body>
  ...
  <section id="playlist" class="container-fluid shared-padding">
    ...
    <div class="row row-cols-1 row-cols-md-5 g-4">
      ...
      $username = "root";
      $password = "";
      $dbname = "admin_website"; // replace with your database name
  ...
  <section id="about" class="shared-padding">
    ...
    <div class="card card-noborder mb-2" style="max-width: 100%;">
      <div class="row g-6">
        <div class="col-md-3">
          <img src="./img/ferdian.png" class="card card-cover card-ferdian img-fluid rounded-start" style="max-width: 100%;" alt="Ferdian">
        </div>
        <div class="col-md-9">
          <div class="card-body">
            <h4 class="card-title">Hai,</h4>
            <p class="card-text">Saya adalah mahasiswa Teknik Informatika yang memiliki minat besar dalam pengembangan web, desain grafis, dan teknologi informasi. Saat ini, saya sedang menempuh mata kuliah Pemrograman Berbasis Web yang diasuh oleh Pak Ramadhan Rakhmat Sani, M.Kom.</p>
