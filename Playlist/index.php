...
<body>
  ...
  <section id="hero" class="container-fluid shared-padding">
    ...
    <div class="row mb-2">
      <div class="col-md-6">
        <div
          ...
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2 text-primary-emphasis">Tupac Shakur</strong>
      ...
      <div class="col-md-6">
        <div
          class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2 text-success-emphasis">Kendrick Lamar</strong>
    ...
    <div class="btn-group">
      <a href="#" class="btn btn-outline-secondary" aria-current="page">
      ...
      ?>
        <div class="col">
          <div class="card h-100">
            <img src="img/<?= $row["gambar"] ?>" class="card-img-top" alt="hindia" />
            <div class="card-body">
              <h5 class="card-title"><?= $row["judul"] ?></h5>
            </div>
            <div class="card-footer">
              <small class="text-body-secondary"><?= $row["artis"] ?></small>
            </div>
          </div>
        </div>
      <?php
  ...
  <section id="galeri" class="container-fluid shared-padding">
    ...
    <div class="container" id="custom-cards">
      <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-0">
        <div class="col">
          <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4" style="background-image: url('./img/manggung.jpg');">
            <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
              <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Whole Lotta Red</h3>
        ...
        <div class="col">
          <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4" style="background-image: url('./img/hozier.png');">
            <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
        ...
        <div class="col">
          <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4" style="background-image: url('./img/playboihitam2.png');">
  ...
  <section id="about" class="shared-padding">
    ...
    <div class="card card-noborder mb-2" style="max-width: 100%;">
      <div class="row g-6">
        <div class="col-md-3 center">
          <img src="./img/ferdian.png" class="card card-cover card-ferdian img-fluid rounded-start" style="max-width: 90%;" alt="Ferdian">
        </div>
        <div class="col-md-9">
          <div class="card-body">
            <h4 class="card-title">Hai,</h4>
            <p class="card-text">Saya Ferdian Nur Fariza - A11.2023.15074 adalah mahasiswa Teknik Informatika yang memiliki minat besar dalam pengembangan web, desain grafis, dan teknologi informasi. Saat ini, saya sedang menempuh mata kuliah Pemrograman Berbasis Web yang diasuh oleh Pak Ramadhan Rakhmat Sani, M.Kom.</p>
            <p class="card-text">Saya memiliki keterampilan dalam pemrograman HTML, CSS, dan pengembangan situs web, serta pengalaman dalam mendesain elemen grafis untuk acara resmi di Universitas Dian Nuswantoro. Selain itu, saya juga memiliki minat dalam desain logo dan pembuatan prototipe aplikasi pendidikan.
            </p>
            <p class="card-text">
              Dalam setiap proyek yang saya kerjakan, saya selalu mengutamakan kreativitas, fungsionalitas, dan desain yang menarik. Saya berkomitmen untuk terus belajar dan mengembangkan keterampilan di bidang teknologi informasi untuk mendukung karir profesional saya di masa depan.
            </p>
